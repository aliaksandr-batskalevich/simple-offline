...
const getFullUsers = (state: RootStateType): Array<IUser> | null => state.users.users;
...
export const getFollowingUsers = (state: RootStateType): Array<number> => state.users.followingUsers;
